...
- **📦 Installer**: [Download YouTube Video Downloader v2.1.0](https://github.com/raihannishat/youtube-video-downloader/releases/latest/download/YouTubeVideoDownloader-Setup-v2.1.0.exe) (Direct Download)
  - File: `YouTubeVideoDownloader-Setup-v2.1.0.exe`
...
4. Installer will be created at: `installer\YouTubeVideoDownloader-Setup-v2.1.0.exe`
