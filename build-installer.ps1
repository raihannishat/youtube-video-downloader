...
if ($innoSetupFound) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host ""
        Write-Host "Installer location: installer\YouTubeVideoDownloader-Setup-v2.1.0.exe" -ForegroundColor Cyan
    } else {
    ...
    $zipPath = "installer\YouTubeVideoDownloader-v2.1.0.zip"
    ...
    if (Test-Path $exePath) {
        ...
        # Create ZIP file
        $zipFullPath = Resolve-Path "installer" | Join-Path -ChildPath "YouTubeVideoDownloader-v2.1.0.zip"
