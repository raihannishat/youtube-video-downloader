...
if ($innoSetupFound) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host ""
        Write-Host "Installer location: installer\YouTubeVideoDownloader-Setup-v1.2.1.exe" -ForegroundColor Cyan
    } else {
    ...
    $zipPath = "installer\YouTubeVideoDownloader-v1.2.1.zip"
    ...
    if (Test-Path $exePath) {
        ...
        # Create ZIP file
        $zipFullPath = Resolve-Path "installer" | Join-Path -ChildPath "YouTubeVideoDownloader-v1.2.1.zip"
